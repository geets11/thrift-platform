...
<head>
    ...
    <title>@yield('title', 'Admin - Thrift Fashion')</title>
    ...
    <div class="admin-layout">
        <aside class="admin-sidebar">
            ...
            <nav class="admin-nav">
                ...
                <a href="{{ route('admin.notifications') }}" class="admin-nav-item {{ request()->routeIs('admin.notifications') ? 'active' : '' }}">
        ...
        <main class="admin-main">
            <header class="admin-header">
                <h1 class="admin-header-title">Thrift Fashion Admin</h1>
            </header>
