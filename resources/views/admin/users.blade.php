...
@section('title', 'Users - Thrift Platform')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Users</h1>
        <p class="mt-2 text-gray-600">Manage platform users (Admin only)</p>
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse(App\Models\User::latest()->paginate(20) as $user)
                            <tr>
    ...
    @else
        <div class="bg-white rounded-lg shadow p-8 text-center">
            ...
            <p class="text-gray-600 mb-4">Only administrators can access this page.</p>
